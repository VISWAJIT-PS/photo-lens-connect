...
// Mock data with complete JSON structure
...
export const ChatApp: React.FC<ChatTabProps> = ({ conversationId }) => {
  ...
  const renderConversationList = () => (
    <div className="w-full lg:w-80 h-full border-r border-gray-200 bg-white flex flex-col">
      {/* Header */}
              ...
              <div className="flex items-start space-x-3">
                <div className="relative">
                  <img
                    ...
                    onError={(e) => {
                      e.currentTarget.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(conversation.name)}&size=40`;
                    }}
                  />
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex items-center justify-between mb-1">
                    <h4 className="font-medium truncate text-gray-900">{conversation.name}</h4>
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    {conversation.unreadCount > 0 && (
                      <span className="h-5 w-5 bg-blue-500 text-white rounded-full flex items-center justify-center text-xs font-medium">
            ...
            <div className="flex items-center space-x-3">
              ...
              <div className="relative">
                <img
                  ...
                  className="h-10 w-10 rounded-full object-cover"
                  onError={(e) => {
                    e.currentTarget.src = `https://ui-avatars.com/api/?name=${encodeURIComponent(selectedConversation.name)}&size=40`;
                  }}
                />
